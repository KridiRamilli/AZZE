        ...
        <div className='heroContainer'>
          <div className='relative isolate px-6 lg:px-8'>
            <div className='flex md:flex-row sm:flex-col'>
              <div className='mx-auto max-w-4xl sm:pt-32 lg:pt-32 flex-4'>
                ...
                >
                  <div className='tokenStats flex flex-col w-full h-72 px-6 lg:px-8 mt-4'>
                    <div className='tokenStabel flex flex-row justify-around h-1/2 py-3'>
                      {generateYeildCard(standardTokenObj)}
                    </div>
                    <div className='tokenCrypto flex flex-row h-1/2 py-3'>
